      ...
      <div className="bg-lightGray1 p-sm-5 p-3">
        <div className="d-custom-flex align-item-center gap-5 mb-5">
          <div className="bg-white p-4 w-md-75 mb-custom-4">
            ...
            <div className="d-flex flex-direction-column gap-5 h-100">
              <div>
                <label htmlFor="organisations.company_name" className="d-block">
                  Company Name
                </label>
                <input
                  type="text"
        ...
        <div className="bg-white p-4 d-flex flex-direction-column gap-4">
          ...
          <div className="d-flex gap-5 flex-wrap">
            ...
            {/* <div className="w-md-45">
              <label htmlFor="offlineTime" className="d-block">
                Offline Time
              </label>
              <input
                type="text"
            ...
            {/* <div className="w-md-45">
              <label htmlFor="defaultAppProductivity" className="d-block">
                Default Application Productivity
              </label>
              <input
                type="text"
                name="defaultAppProductivity"
                value={formData.defaultAppProductivity}
                onChange={handleChange}
                className="rounded-2 border py-2 px-3 w-100"
              />
            </div> */}
