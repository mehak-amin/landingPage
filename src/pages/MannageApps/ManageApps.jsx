...
const ManageApps = () => {
  ...
  const selectStyle = {
    backgroundColor: selectedOption === 'productive' ? 'rgba(54, 196, 73, 1)' : 
                     selectedOption === 'unproductive' ? 'red' : 'grey',
...
<div className="top-div-manageapps">
 ...
 <h4 className='filter-manageapps'><FontAwesomeIcon icon={faFilter}/></h4>
    ...
    <div className="center-div-manageapps">
        ...
        <div className="center-top-manageapps">
          ...
          <div className="search-manageapps">
            <input type="text" placeholder='Search Apps..!' /><div className="search-icon"><FontAwesomeIcon icon={faMagnifyingGlass} /></div>
          </div>
...
{addApp && 
      <div className="addapp-popup-wrapper">
        ...
        <div className="addapp-top-manageapps">
            <h4>Add App</h4>
            <div onClick={toggleAddApp}><h4><FontAwesomeIcon icon={faCircleXmark} /></h4></div>
          </div>
          <div className="addapp-center-manageapps">
            ...
            <div className="addapp-bottom-center-manageapps">
                ...
                <select value={selectedOption} onChange={handleChange} style={selectStyle}>
      ...
      <option value="neutral">Neutral</option>
          ...
          <div className="addapp-bottom-manageapps">
            <div className="addapp-cancle-bottom-manageapps"><h6>Cancel</h6></div>
            <div className="addapp-invite-bottom-manageapps"><h6>Add App</h6></div>
          </div>
      </div>
      </div>
      }
      ...
      <div className="bottom-div-manageapps">
        <div className="content-bottom-div-manageapps">
            ...
            <div className="table-container-manageapps">
                <table>
                    <tr className='table-headding-manageapps'>
                        ...
                        <th><h6>Change Type</h6></th>
                    </tr>
                    <tr>
                        <td className='table-data-appname-manageapps'><input type="checkbox" /> <h6>Figma</h6> <img src={figma} alt="image" /></td>
                        <td><h6 style={{color:"green"}}>Productive</h6></td>
            
                        <td><h6><FontAwesomeIcon icon={faEllipsis} /></h6></td>
                    </tr>
                    <tr>
                        <td className='table-data-appname-manageapps'><input type="checkbox" /> <h6>Youtube</h6> <img src={youtube} alt="image" /></td>
                        <td><h6 style={{color:'red'}}>Unproductive</h6></td>
                        
                        <td><h6><FontAwesomeIcon icon={faEllipsis} /></h6></td>
                    </tr>
                    <tr>
                        <td className='table-data-appname-manageapps'><input type="checkbox" /> <h6>Discord</h6> <img src={discord} alt="image" /></td>
                        <td><h6 style={{color:'#b3b3b3'}}>Neutral</h6></td>
            ...
            <div className="responsive-table-manageapps">
                <table>
                    <tr>
                        <td><h6>App Name</h6></td>
                        <td className='table-data-appname-manageapps'> <h6>Figma</h6> <img src={figma} alt="image" /><input type="checkbox" /></td>
                    </tr>
                    <tr>
                        <td><h6>Type</h6></td>
                        <td style={{color:'green'}}><h6>Productive</h6></td>
                    </tr>
                    <tr>
                        <td><h6>Change Type</h6></td>
                        <td><h6><FontAwesomeIcon icon={faEllipsis} /></h6></td>
                    </tr>
                </table>
            </div>
